...
\setmonofont[Scale=0.8]{Bitstream Vera Mono} 
...
email: \href{mailto:eliza@extrasolar.space}{\texttt{eliza@extrasolar.space}}\\
\textsc{url}: \href{https://extrasolar.space}{\texttt{https:///extrasolar.space}}\\ 
%Born:  March 12, 1879---Ulm, Germany\\
%Nationality:  German/American

%%\hrule
\section*{Areas of Interest}
Functional programming; programming languages \& compilers; systems programming, operating systems \& embedded.

%\hrule
\section*{Skills}

\textit{Languages:} Rust, Haskell, Scala, Java, Python, C \& C++.\\


%%\hrule
\section*{Appointments held}

\noindent\years{1903-1908}Swiss Patent Office, Bern\\
...
\noindent\years{1900}\textsc{MSc} in Physics, ETH Zürich\\
